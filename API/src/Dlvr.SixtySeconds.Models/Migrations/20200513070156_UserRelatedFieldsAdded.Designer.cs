...
namespace Dlvr.SixtySeconds.Models.Migrations
{
    ...
    [Migration("20200513070156_UserRelatedFieldsAdded")]
    partial class UserRelatedFieldsAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dlvr.SixtySeconds.Models.User", b =>
                {
                    ...
                    b.HasIndex("ReportTo")
                        .IsUnique()
                        .HasFilter("[ReportTo] IS NOT NULL");

                    b.HasIndex("UpdatedBy")
                        .IsUnique()
                        .HasFilter("[UpdatedBy] IS NOT NULL");
            ...
            modelBuilder.Entity("Dlvr.SixtySeconds.Models.BusinessUnitUser", b =>
                {
                    ...
                    b.HasOne("Dlvr.SixtySeconds.Models.Role", "Role")
                        .WithOne()
                        .HasForeignKey("Dlvr.SixtySeconds.Models.BusinessUnitUser", "RoleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Dlvr.SixtySeconds.Models.NotificationUser", b =>
                {
                    b.HasOne("Dlvr.SixtySeconds.Models.BusinessUnit", "BusinessUnit")
                        .WithOne()
                        .HasForeignKey("Dlvr.SixtySeconds.Models.NotificationUser", "BusinessUnitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Dlvr.SixtySeconds.Models.Notification", "Notification")
                        .WithOne()
                        .HasForeignKey("Dlvr.SixtySeconds.Models.NotificationUser", "NotificationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Dlvr.SixtySeconds.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("Dlvr.SixtySeconds.Models.NotificationUser", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Dlvr.SixtySeconds.Models.User", b =>
                {
                    b.HasOne("Dlvr.SixtySeconds.Models.BusinessUnit", null)
                        .WithMany("BusinessUnitUsers")
                        .HasForeignKey("BusinessUnitId");

                    b.HasOne("Dlvr.SixtySeconds.Models.User", "CreatedByUser")
                        .WithOne()
                        .HasForeignKey("Dlvr.SixtySeconds.Models.User", "CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Dlvr.SixtySeconds.Models.User", "DeletedByUser")
                        .WithOne()
                        .HasForeignKey("Dlvr.SixtySeconds.Models.User", "DeletedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Dlvr.SixtySeconds.Models.User", "ReportToUser")
                        .WithOne()
                        .HasForeignKey("Dlvr.SixtySeconds.Models.User", "ReportTo")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Dlvr.SixtySeconds.Models.User", "UpdatedByUser")
                        .WithOne()
                        .HasForeignKey("Dlvr.SixtySeconds.Models.User", "UpdatedBy")
                        .OnDelete(DeleteBehavior.Restrict);
                });
