...
export default class Recording extends React.Component {
  ...
  async _stopRecording() {
    ...
    this.props.navigation.navigate("AudioPlayback", {
      audio: { recordingStop, timeStamp }
    })
  }
      ...
      <View
        ...
        <ImageBackground source={require('../../../assets/header_bar.png')} style={styles.backgroundImage} imageStyle={{ resizeMode: 'contain', top: 0, justifyContent: 'center', }}>
          <View style={{
            ...
            <Text style={{ color: '#fff', fontSize: 20 * ratio }}>Audio Rehearse</Text>
        ...
        <ScrollView style={{ flex: 0.6, height: '100%', padding: 20 }}>
          <Text style={styles.text}>Hi Trevor, how's the weather today?</Text>
          <Text style={styles.text}>
            But just think about how would you keep the rest of you dry.
          </Text>
          <Text style={styles.text}>
            You could make good use of the hands free umbrella that we just
            invented
          </Text>
        </ScrollView>
        <View
...
const styles = StyleSheet.create({
  text: { fontSize: 32, color: 'white', paddingBottom: 20 },
  recordingTimestamp: {
    paddingLeft: 20,
    color: 'white',
    alignSelf: 'center'
